...
window.adicionarCampo = function () { // Adicione 'window.' aqui    
    ...
    document.getElementById('dimensoes').insertAdjacentHTML('beforeend', '<div class="form-group row" id="campo' + controleCampo + '"><div   class="col" style="text-align: center;">' + controleCampo + '</div><div class="col dimens_red"><input type="text" name="comprimento" id="comprimento" oninput="check_dim(this)" pattern="\\d{1,3}" placeholder="comprimento" required></div><div class="col dimens_red"><input type="text" name="largura" id="largura" oninput="check_dim(this)" pattern="\\d{1,3}"  placeholder="largura" required></div><div class="col dimens_red"><input type="text" name="altura" id="altura" oninput="check_dim(this)" pattern="\\d{1,3}"  placeholder="altura" required></div><div class="col dimens_cyan"><input type="text" name="volume" id="volume" oninput="check_dim(this)" pattern="\\d{1,4}"  placeholder="quant_pacotes" required></div><div class="col dimens_black"><input type="text" name="unidades" id="unidades" oninput="check_dim(this)" pattern="\\d{1,4}"  placeholder="unid_pacote" required></div><div class="col larg_botao"><button type="button" id="' + controleCampo + '" class = "campo_neg" onclick="removerCampo(' + controleCampo + ')"> - </button></div></div>');
