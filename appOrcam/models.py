...
class Orcamento(models.Model):
    ...
    def nome_maquina_impressao(self):
        # Usamos o .nome diretamente da FK
        if self.maquina_impressao_id: # Verifica se existe o ID antes de tentar acessar o objeto
            return self.maquina_impressao.nome
        return "Máquina não definida"
    '''
    ...
    def custo_impressao_impresso(self):
        return  self.custo_impressao if self.custo_impressao else Decimal('0.20')
