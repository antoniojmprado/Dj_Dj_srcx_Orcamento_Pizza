...
@admin.register(EncargosTrabalhistas)
class EncargosTrabalhistasAdmin(admin.ModelAdmin):
    list_display = ('id', 'nome', 'aliquota', 'ativo_no_calculo', 'observacao')
...
class OrcamentoAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('preco_final_unitario',
                       ...
                       'area_perda_projeto',
                       'perda_area_total',
                       'perda_area_excedente',
                       'custo_perda_total',
                       'custo_perda_projeto',
                       'custo_perda_excedente',
                       'imprimir_orcamento_btn')  # Adicione o campo do botão aqui
