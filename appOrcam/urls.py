...
urlpatterns = [
    ...
    path('orcamento/<int:pk>/', views.imprimir_orcamento, name='imprimir_orcamento'),  # Como deve estar no seu urls.py
    ...
    path('orcamento_pdf_view/<int:pk>/', views.orcamento_pdf_view,name='orcamento_pdf_view'),
